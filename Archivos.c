...
{
    if(!strstr(arch->clasificador, "Nivel general") && !strstr(arch->clasificador, "Capitulos"))
    {
        if(strstr(linea, "Nivel general"))
